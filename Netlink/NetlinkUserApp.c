 ...
 * =====================================================================================
 *
 *       Filename:  NetlinkUserApp.c
 *
 *    Description:  This file represents the userspace application for Netlink
...
//Utilities function decleration
...
static void exit_userspace(int sock_fd) { close(sock_fd); }
...
int send_netlink_msg_to_kernel(int sock_fd, char *msg, uint32_t msg_size,
  ...
  outermsghdr.msg_name =
      (void *)&dest_addr; /*Whom you are sending this msg to*/
...
int main(int argc, char **argv) {
  ...
  sock_fd = socket(AF_NETLINK, SOCK_RAW, NETLINK_TEST_PROTOCOL);
   ...
   * kernel uses this info to reply back*/
